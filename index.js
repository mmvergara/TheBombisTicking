...
var audfuse = new Audio("fusenew.mp3");
audfuse.volume = 0.6;
var audmetronome = new Audio("metronomenew.mp3");
audmetronome.volume = 0.3;
var audcorrect = new Audio("ping.mp3");
audcorrect.volume = 0.4;
var audboom = new Audio("tntboom.mp3");
var aud100s = new Audio("60sec.mp3");
aud100s.volume = 0.2;
$("#easy").click(() => {
  HMTime = 10000;
  HMChars = 5;
...
$("#hundredSeconds").click(() => {
  // 100 seconds gamemode
  aud100s.play();
  ...
  checker = setInterval(() => {
    if ($("#tuserInput").val() == theRandomtoGuess) {
      //win
      $("#tuserInput").val("").focus();
      audcorrect.play();
      createRandomChar();
